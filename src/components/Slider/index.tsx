      ...
      >
        <SwiperSlide>
          ...
          >
            <Link href={`/continent`}>
              <a>
                <Heading fontSize={["3xl", "4xl", "5xl"]} color="gray.100" fontWeight="bold">China</Heading>
                <Text fontWeight="bold" color="gray.300" fontSize={["0.8rem", "1xl", "2xl"]} mt={["2", "4"]}>O continente do ipman</Text>
              </a>
            </Link>
          </Flex>
        </SwiperSlide>
